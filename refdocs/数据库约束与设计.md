...
(1, '工作台', 'workspace:dashboard', 2, '/', 'views/Dashboard.vue', 'Platform', 10, 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
...
-- 2.4 权限菜单管理
INSERT INTO `bms_permissions` (`parent_id`, `title`, `code`, `type`, `path`, `component`, `icon`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES
(3, '权限菜单管理', 'system:permission', 2, 'permission', 'views/system/PermissionList.vue', 'Lock', 30, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());

-- 权限菜单按钮权限
INSERT INTO `bms_permissions` (`parent_id`, `title`, `code`, `type`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES
(20, '新增', 'system:permission:add', 3, 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(20, '编辑', 'system:permission:edit', 3, 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(20, '删除', 'system:permission:delete', 3, 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());

-- 权限菜单 API 权限
INSERT INTO `bms_permissions` (`parent_id`, `title`, `code`, `type`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES
(20, '新增权限API', 'admin/permission/add', 4, 4, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(20, '编辑权限API', 'admin/permission/edit', 4, 5, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(20, '删除权限API', 'admin/permission/delete', 4, 6, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
...
-- 定时任务按钮权限
INSERT INTO `bms_permissions` (`parent_id`, `title`, `code`, `type`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES
(34, '新增', 'system:crontab:add', 3, 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(34, '编辑', 'system:crontab:edit', 3, 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(34, '删除', 'system:crontab:delete', 3, 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
